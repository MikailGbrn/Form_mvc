...
class ViewForm
{
	...
	function Tampilkan ($data, $pekerjaan)
	{
		?>
		<!DOCTYPE html>
<html>
...
<br></p>
    ...
    <p class="font2 centerImage2">
    <?php
      foreach($data['motto'] as $selected) {
echo $selected."<br>";
}
    ?>
    <br></p>

    <p class="font centerImage2">as your motto.<br><br><br> Thus, we have a conclusion <br></p> 
    	 <p class="font centerImage2">That You Will Work At<br></p>
    ...
    <br></p>
    	...
    	<p class="font centerImage2">and you ARE a Human!<br></p>
